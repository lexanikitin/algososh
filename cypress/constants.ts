...
export const CIRCLE_HEAD = '[data-cy=circle-head]';
export const CIRCLE_TAIL = '[data-cy=circle-tail]';
export const CIRCLE_INDEX = '[data-cy=circle-index]';
export const CIRCLE_LETTER = '[data-cy=circle-letter]';
...
export const MODIFIED_STATE_STYLE = "4px solid rgb(127, 224, 81)";
